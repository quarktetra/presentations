...
var titleinfo= {
      ...
      "text": {
        ...
        "text":"<div class='navBarT'>   <p>This is an interactive timeline of all Jet Propulsion Laboratory(JPL) missions. The data is based on JPL's  <a href='https://www.jpl.nasa.gov/missions/'> missions page</a>. People with a spirit of curiosity might like the opportunity to explore the timeline. </p>  <br> <ul> <li> Use the filters on the top to narrow down the items in the list.</li> <ul> <li> Note that the filters are tied and avaliable options will update dynamically!</li></ul> <li>  Use keyboard arrows or mouse to navigate the timeline.</li>   <li> Contact me at quarktetra@gmail.com  or http://twitter.com/quarktetra for questions. </li> </ul> <br> <br> <strong>Credit for all images and data on this page: Courtesy NASA/JPL-Caltech. </strong> <br><br><br><span style='font-size:2vw;color:orange'> Use fullscreen (F11) for a better view.</span> </div>"
